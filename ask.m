...
% **************************** Modulation *****************************
Ac1 = 10;         % Carrier1 Amplitude
Ac2 = 20;         % Carrier2 Amplitude
br = 1/Tb;       % Bit rate
c1 = Ac1*cos(2*pi*100000*t2);      % carrier signal for binary value '1'
c2 = Ac2*cos(2*pi*100000*t2);      % carrier siignal for binary value '0'
mod = [];
for (i = 1:1:N)
    if (x(i) == 0)
